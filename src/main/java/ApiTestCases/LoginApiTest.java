...
import commonmethods.ApiFileUtils;
...
public class LoginApiTest extends BaseApiTest{
	...
	public void loginTest01() throws IOException
	{
		...
		/*   HashMap<String,String> payload = new HashMap<String,String>();
			payload.put("username", "cheeti.laxmi@tekarch.com");
			...
			request.validateSchema(loginRes, new File(System.getProperty("user.dir")+"\\src\\main\\java\\ResponseSchema\\LoginSchema.jason"));
	...
	public void addUserTest03() throws JsonProcessingException
	{
		...
		user1.put("accountno","TA-1000444");
		user1.put("departmentno","4");
		user1.put("salary","75000");
		user1.put("pincode","505007");*/
		
		
		/*JsonObject user= new JsonObject();
		user.addProperty("accountno","TA-1000444");
		user.addProperty("departmentno","4");
		user.addProperty("salary","75000");
